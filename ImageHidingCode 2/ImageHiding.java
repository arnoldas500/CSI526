...
//   secretCanvas.repaint();
  ...
  {
   int width = this.getHostImage().getWidth(); // width of image
   int height = this.getHostImage().getHeight();  // height of image
   
   int bits = this.getBits() - 1;  // text bits
 ...
 public ImageHiding()
 {
  ...
  JLabel secretImageLabel = new JLabel("No. of characters: ");   //added JLabel
